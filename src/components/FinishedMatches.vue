    ...
    <div class="row">
        ...
        <div class="col d-flex justify-content-center">
            <div class="align-self-center">
                <h3>RESULT</h3>
                <router-link to="/moreInfoFinishedMatches"><p class="m-0">More Info</p></router-link>
            </div>
        </div>
        <div class="col">
...
<div>
    <v-layout row mb-5 align-center>
        ...
        <v-flex xs4 sm4 md4>
            ...
            <p class="mt-4 text-center"><router-link class="no_decoration" to="/moreInfoFinishedMatches">More info here</router-link></p>
        </v-flex>
        <v-flex xs4 sm4 md4>
            <img class="teams_logo" src="../../../bayern.png" alt="team logo">
